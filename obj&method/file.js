...
//     }
// }
// let Danish=new Engineer();

const food = ['apple','peach','cucumber','papaya','dates','apricoat']

// const peach=food.map((item)=>'peach')
// console.log(peach);
// const duplicateFood=food.map((any)=>any+any)
// ;
// console.log(duplicateFood);

const fruits=food.filter((item)=>item.type==='fruite');
console.log(fruits)